# Generated by Django 5.1.1 on 2024-10-01 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Статус выполнения задачи', on_delete=django.db.models.deletion.CASCADE, to='gamification.status', verbose_name='Статус')),
