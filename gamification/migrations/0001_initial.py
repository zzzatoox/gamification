    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Фотография достижения', null=True, upload_to='achievements/', verbose_name='Фото')),
                ('title', models.CharField(help_text='Заголовок достижения', max_length=30, verbose_name='Заголовок')),
                ('description', models.CharField(help_text='Описание достижения', max_length=100, verbose_name='Описание')),
                ('xp_reward', models.IntegerField(help_text='Количество опыта за получение достижения', verbose_name='Награда за выполнение (XP)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(default=0, help_text='Цена товара', verbose_name='Цена')),
                ('image', models.ImageField(blank=True, help_text='Фотография достижения', null=True, upload_to='products/', verbose_name='Фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xp_reward', models.IntegerField(help_text='Количество опыта за выполнение задачи', verbose_name='Награда за выполнение (XP)')),
        ...
        migrations.CreateModel(
            name='Inventory',
            fields=[
                ('inventory_id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID инвентаря')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.ForeignKey(blank=True, help_text='Звание пользователя', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gamification.rank', verbose_name='Звание')),
